      ...
      <header style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <span style={{ fontSize: 20, fontWeight: "bold", color: "#d4a843", letterSpacing: 3 }}>
            LOVIX<span style={{ color: "#e8e0d0" }}>STREAM</span>
          </span>
        </div>
...
// ══════════════════════════════════════════════════════════════════
// Composant ok : Carte film publique
// ══════════════════════════════════════════════════════════════════
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: 16 }}>
        ...
        {movie.description && (
          <p style={{
            color: "#444", fontSize: 12, margin: "0 0 12px", lineHeight: 1.5,
    ...
    <div style={{
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{ fontWeight: "bold", fontSize: 16, color: movie.blocked ? "#555" : "#e8e0d0" }}>
          ...
          {movie.blocked && (
            <span style={{
              marginLeft: 10, fontSize: 11, color: "#c0392b",
